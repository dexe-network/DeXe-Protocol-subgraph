...
import { INVEST_POOL_NAME } from "../src/entities/global/globals";
...
describe("PoolFactory", () => {
  ...
  test("should handle TraderPoolDeployed event", () => {
    let expectedPoolType = INVEST_POOL_NAME;
    let expectedSymbol = "INTP";
    let expectedName = "Invest Trader Pool";
    ...
    assert.fieldEquals("InvestPool", expectedAt.toHexString(), "baseToken", expectedBasicToken.toHexString());
    assert.fieldEquals(
      "ProposalContract",
