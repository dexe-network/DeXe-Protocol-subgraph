import { Exchanged, PositionClosed, InvestorAdded, Invest, InvestorRemoved, Divest, MintLP, BurnLP } from "../../generated/templates/InvestPool/InvestPool"
...
export function onInvest(event: Invest): void {
  ...
  let invest = getInvestInInvestPool(event.transaction.hash, investorInfo.id, event.params.amount, event.params.toMintLP);
