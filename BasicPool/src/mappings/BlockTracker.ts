...
import { TraderPoolRegistry } from "../../generated/BSCValidatorSet/TraderPoolRegistry";
import { BASIC_POOL_NAME, POOL_OFFSET, POOL_REGISTRY_ADDRESS } from "../entities/global/globals";

export function onBlock(event: ethereum.Event): void {
