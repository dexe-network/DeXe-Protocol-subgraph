...
function createProposalCreated(
  ...
  event.parameters.push(new ethereum.EventParam("executorType", ethereum.Value.fromI32(executorType)));
...
describe("DaoPool", () => {
  ...
  test("should handle ProposalCreated", () => {
    ...
    let event = createProposalCreated(proposalId, sender, quorum, executorType, contractSender, block, tx);
