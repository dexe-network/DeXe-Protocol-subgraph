...
export enum TransactionType {
  ...
  DAO_POOL_REWARD_CLAIMED = 32,
  DAO_POOL_DEPOSITED = 33,
  DAO_POOL_WITHDRAWN = 34,
  DAO_POOL_MOVED_TO_VALIDATORS = 35,
  DAO_POOL_OFFCHAIN_RESULTS_SAVED = 36,

  DAO_VALIDATORS_VOTED = 37,
  DAO_VALIDATORS_PROPOSAL_CREATED = 38,
  DAO_VALIDATORS_PROPOSAL_EXECUTED = 39,
}
