...
export function getInvestment(id: string, investor: Address = Address.zero(), volume: BigInt = BigInt.fromI32(0), lpPurchasePrice: BigInt = BigInt.fromI32(0)): Investment {
